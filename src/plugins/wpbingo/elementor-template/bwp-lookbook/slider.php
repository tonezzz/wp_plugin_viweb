<?php
	...
	<div class="bwp-lookbook <?php echo esc_attr($layout); ?>">
		...
		<div class="slick-carousel" data-autoplay="false" data-infinite="true" data-nav="<?php echo esc_attr($show_nav);?>" data-dots="<?php echo esc_attr($show_pag);?>" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>" >
		...
		<div class="box-title">
			<div class="content-info">
				...
				<?php } ?>
				<?php if($title1) { ?>
					<h2 class="title-lookbook"><?php echo wp_kses($title1, $arr); ?><span class="count"><?php echo esc_html($j); ?></span></h2>
				<?php } ?>
				<?php if($description) { ?>
