...
<header id='bwp-header' class="bwp-header header-v7 header-absolute header-color__white menu-left">
	<?php if($sticky_header) { mafoil_menu_stcky(); } ?>
	<?php mafoil_campbar(); ?>
	<?php if(get_theme_mod('top_bar_7', '')) { ?>
		<div id="bwp-topbar" class="topbar-v1<?php if(!get_theme_mod('topbar_mobile','')) { ?> hidden-sm hidden-xs <?php } ?>">
			<div class="topbar-inner">
				<div class="container">
					<div class="topbar-container">
						<?php if(get_theme_mod('content_left_top_bar_7', '')) { ?>
							<div class="topbar-left">
								<?php echo get_theme_mod('content_left_top_bar_7', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_center_top_bar_7', '')) { ?>
							<div class="topbar-center">
								<?php echo get_theme_mod('content_center_top_bar_7', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_right_top_bar_7', '')) { ?>
							<div class="topbar-right">
								<?php echo get_theme_mod('content_right_top_bar_7', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('social_7', '') && shortcode_exists("social_link")) { ?>
