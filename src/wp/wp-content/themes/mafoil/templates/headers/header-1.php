			...
			<div class="topbar-inner">
				<div class="container">
					<div class="topbar-container">
						<?php if(get_theme_mod('content_left_top_bar_1', '')) { ?>
							<div class="topbar-left">
								<?php echo get_theme_mod('content_left_top_bar_1', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_center_top_bar_1', '')) { ?>
							<div class="topbar-center">
								<?php echo get_theme_mod('content_center_top_bar_1', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_right_top_bar_1', '')) { ?>
							<div class="topbar-right">
								<?php echo get_theme_mod('content_right_top_bar_1', ''); ?>
							</div>
						<?php } ?>
				...
				<div class="container">
					<div class="header-container">
						<div class="header-left">
							<?php if(get_theme_mod('phone_1', '+866.597.2742')) { ?>
								<div class="phone hidden-xs">
									<i class="icon-phone"></i>
									<a href="tel:<?php echo get_theme_mod('phone_1', '+866.597.2742'); ?>">
										<?php echo get_theme_mod('phone_1', '+866.597.2742'); ?>
									</a>
								</div>
							<?php } ?>
						</div>
