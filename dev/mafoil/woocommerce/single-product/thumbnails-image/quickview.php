...
remove_action( 'woocommerce_single_product_summary', 'mafoil_add_thumb_single_product', 40 );
remove_action( 'woocommerce_after_single_product', 'mafoil_sticky_cart', 50 );
...
remove_action( 'woocommerce_single_product_summary', 'mafoil_add_loop_wishlist_link', 35 );
...
<div id="quickview-slick-carousel">
	<div class="images">
		<div class="scroll-image">
			...
			<?php if($video_style == 'popup' && $video ){ mafoil_get_video_product(); } ?>
		</div>
	</div>
</div>