    ...
    */
    class mafoil_mega_menu {
        ...
        function __construct() {
			...
			add_action( 'wp_nav_menu_item_custom_fields', array( $this, 'mafoil_mega_menu_add_custom_fields' ), 10, 5 );
            // add custom menu fields to menu
            add_filter( 'wp_setup_nav_menu_item', array( $this, 'mafoil_mega_menu_add_custom_nav_fields' ) );
            // save menu custom fields
            add_action( 'wp_update_nav_menu_item', array( $this, 'mafoil_mega_menu_update_custom_nav_fields' ), 10, 3 );
            // edit menu walker
            add_filter( 'wp_edit_nav_menu_walker', array( $this, 'mafoil_mega_menu_edit_walker' ), 10, 2 );
        } // end constructor
        /**
        ...
        function mafoil_mega_menu_add_custom_fields( $item_id, $item, $depth, $args ) {
			?>
        	<div class="menu-options">
				<?php if ( $depth == 0 ) { ?>
					<h4><?php esc_html_e( 'Mega Menu Options', 'mafoil' ); ?></h4>
					<p class="field-custom description description-wide">
						<label for="edit-menu-megamenu-<?php echo esc_attr($item_id); ?>">
							<?php esc_html_e( 'Enable Mega Menu', 'mafoil' ); ?>
					...
					<p class="field-custom description description-wide">
						<label for="edit-menu-is-fullwidth-<?php echo esc_attr($item_id); ?>">
							<?php esc_html_e( 'Full Width Mega Menu', 'mafoil' ); ?>
                ...
                <h4><?php esc_html_e( 'Custom Menu Options', 'mafoil' ); ?></h4>
                <p class="field-custom description description-wide">
                    <label for="edit-menu-loggedin-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Visible only when logged in', 'mafoil' ); ?>
                ...
                <p class="field-custom description description-wide">
                    <label for="edit-menu-loggedout-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Visible only when logged out', 'mafoil' ); ?>
				...
				<p class="field-custom description description-wide">
					...
					<?php esc_html_e( 'New Badge', 'mafoil' ); ?>
				...
				<p class="field-custom description description-wide">
					<label for="edit-menu-salebadge-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Sale Badge', 'mafoil' ); ?>
                ...
                <?php if ( $depth == 0 ) { ?>
					<p class="field-custom description description-thin">
						<label for="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>">
							<?php esc_html_e( 'Menu Icon (Icon Mind / Font Awesome)', 'mafoil' ); ?>
					...
					<p class="field-imagemenu description description-wide">
						...
						<?php esc_html_e( 'Menu Thumbnail', 'mafoil' ); ?>
						...
						<?php } ?>
						<a class="bwp_upload_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagemenu-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Browse', 'mafoil' ); ?></a>
						<a class="bwp_remove_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagemenu-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Remove', 'mafoil' ); ?></a>
						</label>
					</p>					
                <?php } ?>
            </div>
         ...
         * @return      void
         */
        function mafoil_mega_menu_add_custom_nav_fields( $menu_item ) {
         ...
         * @return      void
         */
        function mafoil_mega_menu_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
         ...
         * @return      void
         */
        function mafoil_mega_menu_edit_walker( $walker, $menu_id ) {
            return 'Walker_Nav_Menu_Edit_Custom';
        }
    }
    $GLOBALS['mafoil_mega_menu'] = new mafoil_mega_menu();
?>