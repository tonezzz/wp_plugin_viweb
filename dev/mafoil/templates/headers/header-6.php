...
<header id='bwp-header' class="bwp-header header-v6 header-absolute header-color__white">
	...
	<?php mafoil_campbar(); ?>
	<?php if(get_theme_mod('top_bar_6', '')) { ?>
		<div id="bwp-topbar" class="topbar-v1<?php if(!get_theme_mod('topbar_mobile','')) { ?> hidden-sm hidden-xs <?php } ?>">
			<div class="topbar-inner">
				<div class="container">
					<div class="topbar-container">
						<?php if(get_theme_mod('content_left_top_bar_6', '')) { ?>
							<div class="topbar-left">
								<?php echo get_theme_mod('content_left_top_bar_6', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_center_top_bar_6', '')) { ?>
							<div class="topbar-center">
								<?php echo get_theme_mod('content_center_top_bar_6', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_right_top_bar_6', '')) { ?>
							<div class="topbar-right">
								<?php echo get_theme_mod('content_right_top_bar_6', ''); ?>
							</div>
						<?php } ?>
