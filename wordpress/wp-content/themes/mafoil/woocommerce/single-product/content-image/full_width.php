...
<div class="images <?php echo esc_attr($class); ?>">
	<figure class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
		<div class="scroll-image">
			<div class="image-additional slick-carousel" <?php if(mafoil_image_single_product()->show_thumb) { ?> data-asnavfor=".image-thumbnail"<?php } ?> data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true" <?php echo esc_attr(mafoil_image_single_product()->class_data_image); ?>>
				<?php
				$attributes = array(
					'id'						=> "image", 	
					'title'                   => $image_title,
				...
				<?php
					if ( $attachment_ids ) {
						...
						foreach ( $attachment_ids as $attachment_id ) { ?>
							...
							$image       = wp_get_attachment_image( $attachment_id, apply_filters( 'mafoil-single-post', 'shop_single' ), 0, $attr = array(
								'title' => $image_title,
								'alt'   => $image_title,
								) );
