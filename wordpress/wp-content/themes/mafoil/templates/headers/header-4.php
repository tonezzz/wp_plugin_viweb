			...
			<div class="topbar-inner">
				<div class="container">
					<div class="topbar-container">
						<?php if(get_theme_mod('content_left_top_bar_4', 'Free shipping on all orders over $50')) { ?>
							<div class="topbar-left">
								<?php echo get_theme_mod('content_left_top_bar_4', 'Free shipping on all orders over $50'); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_center_top_bar_4', '')) { ?>
							<div class="topbar-center">
								<?php echo get_theme_mod('content_center_top_bar_4', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_right_top_bar_4', '<div class="address hidden-xs"><a target="_blank" href="https://www.google.com/maps/place/lastminute.com+London+Eye/@51.503297,-0.119554,10z/data=!4m5!3m4!1s0x0:0x4291f3172409ea92!8m2!3d51.5032973!4d-0.1195537?hl=en">07 Piney Creek Rd, Scottsburg, VA, USA</a></div><div class="email"><a href="mailto:support@mafoil.com">support@mafoil.com</a></div>')) { ?>
							<div class="topbar-right">
								<?php echo get_theme_mod('content_right_top_bar_4', '<div class="address hidden-xs"><a target="_blank" href="https://www.google.com/maps/place/lastminute.com+London+Eye/@51.503297,-0.119554,10z/data=!4m5!3m4!1s0x0:0x4291f3172409ea92!8m2!3d51.5032973!4d-0.1195537?hl=en">07 Piney Creek Rd, Scottsburg, VA, USA</a></div><div class="email"><a href="mailto:support@mafoil.com">support@mafoil.com</a></div>'); ?>
							</div>
						<?php } ?>
