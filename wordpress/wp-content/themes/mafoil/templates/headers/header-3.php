			...
			<div class="topbar-inner">
				<div class="container">
					<div class="topbar-container">
						<?php if(get_theme_mod('content_left_top_bar_3', '<a href="tel:+866.597.2742">Phone: +866.597.2742 </a>')) { ?>
							<div class="topbar-left">
								<?php echo get_theme_mod('content_left_top_bar_3', '<a href="tel:+866.597.2742">Phone: +866.597.2742 </a>'); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_center_top_bar_3', '<div class="free-shipping hidden-xs">Free shipping on all orders over <a href="#">Details</a></div>')) { ?>
							<div class="topbar-center">
								<?php echo get_theme_mod('content_center_top_bar_3', '<div class="free-shipping hidden-xs">Free shipping on all orders over <a href="#">Details</a></div>'); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('content_right_top_bar_3', '')) { ?>
							<div class="topbar-right">
								<?php echo get_theme_mod('content_right_top_bar_3', ''); ?>
							</div>
						<?php } ?>
						<?php if(get_theme_mod('social_3', true) && shortcode_exists("social_link")) { ?>
