...
<div class="container">
	<div class="category-posts row">
		...
		<?php endif; ?>
		<div class="cate-post-content <?php echo esc_attr($sidebar_blog); ?> <?php if(is_active_sidebar('sidebar-blog')){ echo esc_attr(mafoil_get_class()->class_blog_content); }else{ echo "col-lg-12 col-md-12 col-sm-12 col-xs-12"; } ?>">
			<section id="primary" class="content-area">
				...
				<?php 	mafoil_paging_nav(); ?>
			</section><!-- #primary -->
		</div>
		<?php if($sidebar_blog == 'right' && is_active_sidebar('sidebar-blog')): ?>			
			<div class="bwp-sidebar sidebar-blog <?php echo esc_attr(mafoil_get_class()->class_sidebar_right); ?>">
				<?php dynamic_sidebar('sidebar-blog');?>	
			</div>				
		<?php endif; ?>
    </div>
