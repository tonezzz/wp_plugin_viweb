...
function bwp_auto_complete_search_data_via_ajax() {
	$response = array(
		'array'   => '',
		'message' => '',
		'success' => 'no',
                        ...
                        <div data-product_id="<?php echo esc_attr( $child_id ); ?>"
                            ...
                            <div class="product-inner">
                                <div class="post-thumb">
									<?php
									$image = bwp_resize_image( get_post_thumbnail_id(), null, 60, 60, true, true, false );
									?>
...
add_action( 'wp_ajax_bwp_auto_complete_search_data_via_ajax', 'bwp_auto_complete_search_data_via_ajax' );